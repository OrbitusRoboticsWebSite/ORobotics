...
if (root) {
  ...
  const updateWorkshop = () => {
    ...
    ui.loadoutStatus.textContent = `${selectedFinish().name} finish · ${selectedFaceColor().name} smile · ${selectedRanged().name} · ${selectedMelee().name} · Speed L${upgradeLevels.speedBoost} · Energy L${upgradeLevels.energyCapacity} · Power L${upgradeLevels.weaponPower}`;
  };
  const applyLoadout = () => {
